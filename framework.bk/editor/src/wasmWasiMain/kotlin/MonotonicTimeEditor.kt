...
fun mainEditor() {
    ...
    println("Current 'realtime' timestamp is: ${wasiRealTimeEditor()}")
...
fun wasiGetTimeEditor(clockId: Int): Long = withScopedMemoryAllocator { allocator ->
...
fun wasiRealTimeEditor(): Long = wasiGetTimeEditor(REALTIME)

fun wasiMonotonicTimeEditor(): Long = wasiGetTimeEditor(MONOTONIC)
