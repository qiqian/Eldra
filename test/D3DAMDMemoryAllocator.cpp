...
sk_sp<D3DAMDMemoryAllocator> D3DAMDMemoryAllocator::Make(IDXGIAdapter* adapter,
    ID3D12Device* device) {
    ...
    return sk_sp<D3DAMDMemoryAllocator>(new D3DAMDMemoryAllocator(allocator));
}

gr_cp<ID3D12Resource> D3DAMDMemoryAllocator::createResource(
...
gr_cp<ID3D12Resource> D3DAMDMemoryAllocator::createAliasingResource(
